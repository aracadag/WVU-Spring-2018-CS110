...
public class dataMinerTester {
	...
	public static void main(String[] args) {
		...
		if(yesNoInput.equalsIgnoreCase("y")||yesNoInput.equalsIgnoreCase("yes")) {
			...
			System.out.println("Posts that appear 1x: " + dataMiner1.multipleCountArray[0]);
			System.out.println("Posts that appear 2x: " + dataMiner1.multipleCountArray[1]);
			System.out.println("Posts that appear 3x: " + dataMiner1.multipleCountArray[2]);
			System.out.println("Posts that appear 4x: " + dataMiner1.multipleCountArray[3]);
			System.out.println("Posts that appear 5x: " + dataMiner1.multipleCountArray[4]);
			System.out.println("Posts that appear 6x: " + dataMiner1.multipleCountArray[5]);
			System.out.println("Posts that appear 7x: " + dataMiner1.multipleCountArray[6]);
			System.out.println("Posts that appear 8x: " + dataMiner1.multipleCountArray[7]);
			System.out.println("Posts that appear 9x: " + dataMiner1.multipleCountArray[8]);
			System.out.println("Posts that appear 10x: " + dataMiner1.multipleCountArray[9]);
		}
		System.out.println("");
